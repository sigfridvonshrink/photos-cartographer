...
.photos-ingest/
  ...
  photos-00-workspace-guard        workspace root sentinel: marks the workspace as INITIALIZED (written last by prep on init, prep 10_photos-1-prep-workflow.md Section 3.1)
