...
> and validates them — `cartographer/photos_2_geotag.py` (`build_time_decisions`, `build_gps_decisions`,
...
(Source: the `_valid_*` helpers in `cartographer/photos_2_geotag.py`.)
